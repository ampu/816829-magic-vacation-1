...
const EPSILON = 1e-6;
const NEWTON_METHOD_ITERATIONS = 8;
...
class BezierEasing {
  ...
  _solveX(x) {
    ...
    for (let t = x, _ = 0; _ < NEWTON_METHOD_ITERATIONS; _++) {
...
export const createBezierEasing = (p1x, p1y, p2x, p2y) => new BezierEasing(p1x, p1y, p2x, p2y).solve;
